...
CDM8_510,CDM8_610,CDM8_710,CDM8_810,CDM8_910,CDM8_1010]
 ...
 #Approximate 24-bit Integer Multiplier by using nine 8-bit multipliers
def AIM_24(a, b, chromosome, genes_list):
    AL=0
    AM=0
    AH=0
    BL=0
    ...
    mul_1=genes_list[chromosome[0]](AL,BL)
    mul_2=genes_list[chromosome[1]](AM,BL)
    mul_3=genes_list[chromosome[2]](AL,BM)
    mul_4=genes_list[chromosome[3]](AH,BL)
    mul_5=genes_list[chromosome[4]](AM,BM)
    mul_6=genes_list[chromosome[5]](AL,BH)
    mul_7=genes_list[chromosome[6]](AH,BM)
    mul_8=genes_list[chromosome[7]](AM,BH)
    mul_9=genes_list[chromosome[8]](AH,BH)

    result = mul_1 + (mul_2 + mul_3)*(2**8) + (mul_4 + mul_5 + mul_6)*(2**16) + (mul_7 + mul_8)*(2**24) + (mul_9)*(2**32)
    return result   
    
def Rounding(round_bit,sticky,LSB_significand):
    if (round_bit==1):
        if sticky==1:
            increment=1
        elif LSB_significand==1:
            increment=1
        else: increment = 0
    else : increment=0
    return increment
...
def AFPM(a,b,chromosome):
    genes_list = [CDM8_11,CDM8_12,CDM8_13,CDM8_14,CDM8_15,CDM8_16,CDM8_17,CDM8_18,CDM8_19,CDM8_21,CDM8_22,CDM8_23,CDM8_24,CDM8_25,CDM8_26,CDM8_27,CDM8_28,CDM8_29,CDM8_31,
                CDM8_32,CDM8_33,CDM8_34,CDM8_35,CDM8_36,CDM8_37,CDM8_38,CDM8_39,CDM8_41,CDM8_42,CDM8_43,CDM8_44,CDM8_45,CDM8_46,CDM8_47,CDM8_48,CDM8_49,CDM8_51,CDM8_52,
                CDM8_53,CDM8_54,CDM8_55,CDM8_56,CDM8_57,CDM8_58,CDM8_59,CDM8_61,CDM8_62,CDM8_63,CDM8_64,CDM8_65,CDM8_66,CDM8_67,CDM8_68,CDM8_69,CDM8_71,CDM8_72,CDM8_73,
                CDM8_74,CDM8_75,CDM8_76,CDM8_77,CDM8_78,CDM8_79,CDM8_81,CDM8_82,CDM8_83,CDM8_84,CDM8_85,CDM8_86,CDM8_87,CDM8_88,CDM8_89,CDM8_91,CDM8_92,CDM8_93,CDM8_94
                ,CDM8_95,CDM8_96,CDM8_97,CDM8_98,CDM8_99,CDM8_101,CDM8_102,CDM8_103,CDM8_104,CDM8_105,CDM8_106,CDM8_107,CDM8_108,CDM8_109,CDM8_110,CDM8_210,CDM8_310,CDM8_410,
    ...
    st=0
    exponent=0
    mul = AIM_24(a[0:23]+[1],b[0:23]+[1],chromosome,genes_list)
    mul = int_to_48bin(mul)
    
    for i in range(0,22): st = st + mul[i]
    if st!=0: sticky=1 
    else: sticky=0
    
    if mul[47]==0 :
        Round=mul[22]
        significand = mul[23:46]
    else:
        Round = mul[23]
        stm = sticky+mul[22]
        sticky = (stm//2)+(stm%2)
        significand = mul[24:47]
     
    significand = bin23_to_int(significand) + Rounding(Round,sticky,significand[0])
    significand = int_to_24bin(significand)
    final_significand = significand[0:23]
    
    if (mul[47]==1 or significand[23]==1): bias=126 
    else: bias=127
    ...
    result.append(sign)
    result = final_significand + exponent + result
    result.reverse()
    return result
